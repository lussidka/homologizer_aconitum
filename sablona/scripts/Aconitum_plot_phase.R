...
genecopyFn='data/Aconitum_prezentace.csv'
tree_file = 'data/homologizer_map_rooted'
input_dir = 'output/'
output_dir = 'output/'
...
#               'A_tenuisecta_sp2_8704' = c("A_tenuisecta_sp2_8704_A", "A_tenuisecta_sp2_8704_B"),                'A_tenuisecta_sp3_8745' = c("A_tenuisecta_sp3_8745_A", "A_tenuisecta_sp3_8745_B"),
